...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nit' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-25 16:37:13',
                'modified' => '2018-08-25 16:37:13'
            ],
        ];
        parent::init();
    }
