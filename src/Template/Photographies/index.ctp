 ...
 * @var \App\Model\Entity\Photography[]|\Cake\Collection\CollectionInterface $photographies
 */
?>
...
<div class="photographies index large-9 medium-8 columns content">
    <h3><?= __('Photographies') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('nomeclature') ?></th>
                <th scope="col"><?= $this->Paginator->sort('facade') ?></th>
                <th scope="col"><?= $this->Paginator->sort('candidate_family') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $photography->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $photography->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $photography->id], ['confirm' => __('Are you sure you want to delete # {0}?', $photography->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
