...
class SectorsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Departaments', 'Municipalities', 'HomeVisities']
        ];
    ...
    public function view($id = null)
    {
        $sector = $this->Sectors->get($id, [
            'contain' => ['Departaments', 'Municipalities', 'HomeVisities', 'Maps']
        ]);
    ...
    public function add()
    {
        ...
        $departaments = $this->Sectors->Departaments->find('list', ['limit' => 200]);
        $municipalities = $this->Sectors->Municipalities->find('list', ['limit' => 200]);
        $homeVisities = $this->Sectors->HomeVisities->find('list', ['limit' => 200]);
        $this->set(compact('sector', 'departaments', 'municipalities', 'homeVisities'));
    }
