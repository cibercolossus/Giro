...
class ResultsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Components', 'Inspections']
        ];
    ...
    public function add()
    {
        ...
        $components = $this->Results->Components->find('list', ['limit' => 200]);
        $inspections = $this->Results->Inspections->find('list', ['limit' => 200]);
        $this->set(compact('result', 'components', 'inspections'));
    }
